...
try :
    initial = r"C:/Users/harshad/Desktop/Python/ntuproject/data/class2"
    final = r"C:/Users/harshad/Desktop/Python/ntuproject/data/{0}".format(class2)
    os.rename(initial, final)
except :
    pass
...
ds_train = tf.keras.preprocessing.image_dataset_from_directory(
    r'C:\Users\harshad\Desktop\Python\ntuproject\data/',
    labels = "inferred",
    label_mode = "int",
